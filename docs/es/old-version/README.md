...
---
::: danger
Esta documentación es para styde/html 1.5.* y versiones anteriores.
:::
...
[Aprender más sobre el field builder](/es/old-version/field-builder.md)
...
[Aprender más sobre el form builder](/es/old-version/form-builder.md)
...
[Aprender más sobre este componente](/es/old-version/alert-messages.md)
...
[Aprender más sobre el generador de menús](/es/old-version/menu-generator.md)
...
[Aprender más sobre el HTML builder](/es/old-version/html-builder.md)
...
[Aprender más sobre el access handler](/es/old-version/access-handler.md)
...
[Aprender más sobre temas](/es/old-version/themes.md)
...
[Aprender más sobre la internationalización](/es/old-version/internationalization.md)
